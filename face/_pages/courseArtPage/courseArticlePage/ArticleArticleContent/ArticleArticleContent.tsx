	...
	return (
		<div className="article-article">
			<div className="article-article__content">
				...
				<p className="article-article__feedback">
					Обратную связь планируется добавить осенью 2024-го. Пока можете писать вопросы и
					замечания по контактам указанным на{' '}
					<Link href={PageUrls.contacts.url} className="link">
						этой странице
					</Link>
					. Я добавлю или обновлю информацию в главах.
				</p>
			</div>
