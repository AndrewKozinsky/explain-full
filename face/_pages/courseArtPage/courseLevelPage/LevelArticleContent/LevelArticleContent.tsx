...
import { LanguageLevelBadge } from '../../common/LanguageLevelBadge/LanguageLevelBadge'
import LevelArticlesNames from '../LevelArticlesNames/LevelArticlesNames'
	...
	return (
		<div className="level-article">
			<div className="level-article__content">
				...
				<LevelArticlesNames level={article.level} />
			</div>
			<PrevAndNextArticlesNav
