...
// Виджет показывающий полную форму сокращённой
function AbbreviatedFormWidget() {
	const abbreviatedForm = useGetAbbreviatedFormData()
	if (!abbreviatedForm) return null

	return (
		<Widget title="Полная форма" color="gray">
			<WidgetContentPhrase>
				{abbreviatedForm.shortWord}
				<WidgetContentArrow />
				{abbreviatedForm.fullWord}
			</WidgetContentPhrase>
		</Widget>
	)
}

export default AbbreviatedFormWidget
