			...
			children: [
				{
					...
					color: 'black',
					weight: 'normal',
					text: 'Личные местоимения используются для обозначения ',
				},
				{
					type: 'text',
					color: 'blue',
					weight: 'normal',
					text: 'лица совершающего действие',
				},
			...
			children: [
				{
					...
					color: 'black',
					weight: 'normal',
					text: 'Из-за наличия родов в русском языке мы можем называть предметы «он» или «она». Например: «Она сломалась» в отношении машины. Но в английском родов нет. Поэтому все объекты кроме людей называют через it. Но при обратном переводе нужно it менять на подходящее местоимение в зависимости от рода.',
				},
			],
		},
		{
								...
								children: [
									{
										...
										color: 'black',
										weight: 'normal',
										text: 'Через it можно обозначить неодушевлённый предмет в единственном числе. А через какое местоимение можно обозначить несколько предметов?',
									},
								],
							},
						],
